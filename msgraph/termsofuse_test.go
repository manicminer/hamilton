...
type TermsOfUseAgreementTest struct {
	connection   *test.Connection
	tosClient    *msgraph.TermsOfUseAgreementClient
	randomString string
}

func TestTermsOfUseAgreementClient(t *testing.T) {
	c := TermsOfUseAgreementTest{
		connection:   test.NewConnection(auth.MsGraph, auth.TokenVersion2),
		randomString: test.RandomString(),
	}

	c.tosClient = msgraph.NewTermsOfUseAgreementClient(c.connection.AuthConfig.TenantID)
	c.tosClient.BaseClient.Authorizer = c.connection.Authorizer
	...
	agreement := testTermsOfUseAgreementClient_Create(t, c, msgraph.TermsOfUseAgreement{
		...
		Files: &[]msgraph.TermsOfUseAgreementFilesSet{
			{
...
func testTermsOfUseAgreementClient_Create(t *testing.T, c TermsOfUseAgreementTest, a msgraph.TermsOfUseAgreement) (TermsOfUse *msgraph.TermsOfUseAgreement) {
	TermsOfUse, status, err := c.tosClient.Create(c.connection.Context, a)
	if err != nil {
...
func testTermsOfUseAgreementClient_Get(t *testing.T, c TermsOfUseAgreementTest, id string) (agreement *msgraph.TermsOfUseAgreement) {
	agreement, status, err := c.tosClient.Get(c.connection.Context, id)
	if err != nil {
...
func testTermsOfUseAgreementClient_Update(t *testing.T, c TermsOfUseAgreementTest, agreement msgraph.TermsOfUseAgreement) {
	status, err := c.tosClient.Update(c.connection.Context, agreement)
	if err != nil {
...
func testTermsOfUseAgreementClient_List(t *testing.T, c TermsOfUseAgreementTest) (policies *[]msgraph.TermsOfUseAgreement) {
	policies, _, err := c.tosClient.List(c.connection.Context, "")
	if err != nil {
...
func testTermsOfUseAgreementClient_Delete(t *testing.T, c TermsOfUseAgreementTest, id string) {
	status, err := c.tosClient.Delete(c.connection.Context, id)
	if err != nil {
